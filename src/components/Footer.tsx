...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#182423] text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="md:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-lg flex items-center justify-center">
                <span className="text-[#0B7272] font-bold text-xl">S</span>
              </div>
              <span className="text-2xl font-bold">Skillverse</span>
            </Link>
            <p className="text-gray-300 max-w-md mb-6">
              Revolutionizing India&apos;s education landscape by building a nationwide movement to unlock human potential in every corner of India.
            </p>
            {/* Social Links */}
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-300">
              <li>
                <a href="mailto:hello@skillverse.co.in" className="hover:text-white transition-colors duration-200">
                  hello@skillverse.co.in
                </a>
              </li>
              <li>
                <Link href="/contact#webinar" className="hover:text-white transition-colors duration-200">
