...
export default function ContactPage() {
  return (
    <>
      ...
      <Section id="webinar">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-center">
                <svg className="w-6 h-6 text-[#0B7272] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z" />
                </svg>
                <span className="text-gray-700 font-semibold">28 December 2025</span>
              </div>
              <div className="flex items-center">
                <svg className="w-6 h-6 text-[#0B7272] mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-3xl p-8">
            <h3 className="text-xl font-bold text-[#0B7272] mb-6">What You&apos;ll Learn</h3>
            <div className="space-y-4">
              {[
                ...
                <div key={index} className="flex items-start">
                  <div className="w-6 h-6 bg-[#0B7272] rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
      ...
      {/* Uncomment the section below after webinar ends on 28 December 2025 */}
      {/*
      <Section background="light" id="form">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-[#0B7272] mb-4">
              Subscribe & Connect
            </h2>
      ...
      */}
      ...
      <Section background="light" id="form">
        <div className="max-w-4xl mx-auto text-center">
          <div className="bg-gradient-to-br from-[#0B7272] to-[#0E8A8A] rounded-3xl p-8 md:p-12 text-white">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              <div className="bg-white/10 px-4 py-2 rounded-lg">
                ...
                <span className="font-semibold">28 December 2025</span>
              </div>
              <div className="bg-white/10 px-4 py-2 rounded-lg">
                <span className="text-2xl mr-2">🎥</span>
            ...
            <Link 
              href="/webinar"
              className="inline-flex items-center px-10 py-4 bg-white text-[#0B7272] font-bold rounded-xl hover:bg-gray-100 transition-all shadow-lg hover:shadow-xl text-lg"
            >
      ...
      <Section>
        <div className="grid md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="w-16 h-16 mx-auto mb-4 bg-[#0B7272]/10 rounded-2xl flex items-center justify-center">
              <svg className="w-8 h-8 text-[#0B7272]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-xl font-bold text-[#0B7272] mb-2">Email Us</h3>
            <a href="mailto:hello@skillverse.co.in" className="text-gray-600 hover:text-[#0B7272] transition-colors">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-[#0B7272] mb-2">Follow Us</h3>
            <div className="flex justify-center space-x-4">
              <a href="#" className="text-gray-600 hover:text-[#0B7272] transition-colors">Twitter</a>
              <a href="#" className="text-gray-600 hover:text-[#0B7272] transition-colors">LinkedIn</a>
              <a href="#" className="text-gray-600 hover:text-[#0B7272] transition-colors">Instagram</a>
            </div>
          </div>
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-bold text-[#0B7272] mb-2">Response Time</h3>
